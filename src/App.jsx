...
const TRAIT = {
  ...
  금:[
    ...
    "결단력과 추진력이 탁월한 금(金)의 기운이 넘칩니다. 한번 방향을 정하면 강하게 밀어붙이는 것�� 이 기업의 가장 큰 강점입니다.",
  ],
  수:[
    ...
    "변화를 두려워하지 않는 수(Water)의 팔자를 타고났습니다. 시대의 흐름을 누구보다 빠르��� 읽고 유연하게 대응하는 것이 이 기업의 핵심 경쟁력입니다.",
  ],
};
...
const PERIOD_POOL = {
  ...
  weekly:{
    great:[
      ...
      "이번 주 금(金)의 기운이 절정입니다. 결���력 있는 실행이 빛을 발합니다.",
  ...
  quarterly:{
    ...
    caution:[
      ...
      "이번 분기는 큰 결정보다 작고 확실한 성과에 집중하는 것이 유���합니다.",
    ],
  },
  yearly:{
    great:[
...
function getCompat(invElem, corpElem) {
  ...
  if(invElem===corpElem){
    ...
    advice="분산 투자로 위험을 줄이�� 것이 현명합니다.";role="역행자형";
  }
